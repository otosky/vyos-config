...
# set firewall name local-iot rule 300 action 'accept'
# set firewall name local-iot rule 300 description 'Rule: accept_discovery_from_volumio'
...
# set firewall name local-iot rule 301 source address '10.66.2.21'
...
set firewall name local-trusted rule 200 description 'Rule: accept_wireguard'
set firewall name local-trusted rule 200 source port '51820'
set firewall name local-trusted rule 200 protocol 'udp'
# set firewall name local-trusted rule 300 action 'accept'
# set firewall name local-trusted rule 300 description 'Rule: accept_discovery_from_volumio'
...
# set firewall name local-trusted rule 301 source address '10.66.2.21'
