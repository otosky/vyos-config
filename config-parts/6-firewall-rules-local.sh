...
# set firewall name local-iot rule 300 description 'Rule: accept_multicast'
# set firewall name local-iot rule 300 destination port '1900,5353'
...
# set firewall name local-trusted rule 300 description 'Rule: accept_multicast'
# set firewall name local-trusted rule 300 destination port '1900,5353'
