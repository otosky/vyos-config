...
set service dhcp-server shared-network-name SERVERS subnet 10.66.1.0/24 name-server '10.5.0.4'
...
set service dhcp-server shared-network-name TRUSTED subnet 10.66.2.0/24 name-server '10.5.0.4'
...
set service dhcp-server shared-network-name IOT subnet 10.66.3.0/24 name-server '10.5.0.4'
