...
set firewall zone guest interface 'br0.30'
...
set firewall zone iot interface 'br0.40'
...
set firewall zone lan interface 'br0'
...
set firewall zone servers interface 'br0.10'
...
set firewall zone trusted interface 'br0.20'
