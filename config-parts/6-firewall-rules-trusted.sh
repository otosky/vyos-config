...
set firewall name trusted-iot rule 300 source address address-group 'ssdp_sources'
set firewall name trusted-iot rule 305 action 'accept'
set firewall name trusted-iot rule 305 description 'Rule: accept_airplay'
set firewall name trusted-iot rule 305 destination port '5000,7100'
set firewall name trusted-iot rule 305 protocol 'tcp'
set firewall name trusted-iot rule 310 action 'accept'
set firewall name trusted-iot rule 310 description 'Rule: accept_chromecast'
set firewall name trusted-iot rule 310 destination port '8008-8009,8443'
...
set firewall name trusted-iot rule 315 source port '32768-61000'
...
set firewall name trusted-local rule 300 source group address-group 'ssdp_sources'
