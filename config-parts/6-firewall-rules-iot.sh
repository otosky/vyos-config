...
set firewall name iot-servers rule 4 description 'Rule: accept_serial_from_tubeszb'
set firewall name iot-servers rule 4 destination group address-group 'k8s_nodes'
set firewall name iot-servers rule 4 destination port '6638'
set firewall name iot-servers rule 4 protocol 'tcp'
set firewall name iot-servers rule 4 source address '10.66.3.5'
