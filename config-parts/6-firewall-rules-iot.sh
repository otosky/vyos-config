...
set firewall name iot-servers rule 7 description 'Rule: accept_hass_from_voice_assistants'
set firewall name iot-servers rule 7 destination group address-group 'k8s_hass'
set firewall name iot-servers rule 7 destination port '8123'
set firewall name iot-servers rule 7 protocol 'tcp'
set firewall name iot-servers rule 7 source group address-group 'voice_assistants'
set firewall name iot-servers rule 8 action 'accept'
set firewall name iot-servers rule 8 description 'Rule: accept_hass_from_kiosk'
set firewall name iot-servers rule 8 destination group address-group 'k8s_hass'
set firewall name iot-servers rule 8 destination port '8123'
set firewall name iot-servers rule 8 protocol 'tcp'
set firewall name iot-servers rule 8 source group address-group 'ha_kiosk'
# set firewall name iot-servers rule 5 action 'accept'
...
set firewall name iot-trusted rule 316 action 'accept'
set firewall name iot-trusted rule 316 description 'Rule: accept_volumio'
set firewall name iot-trusted rule 316 source port '8098'
set firewall name iot-trusted rule 316 protocol 'tcp_udp'

set firewall name iot-trusted rule 400 action 'accept'
set firewall name iot-trusted rule 400 description 'rule: accept_moonlight_tcp'
set firewall name iot-trusted rule 400 source group address-group 'moonlight_clients'
set firewall name iot-trusted rule 400 destination port '47984,47989,48010'
set firewall name iot-trusted rule 400 destination address '10.66.2.22'
set firewall name iot-trusted rule 400 protocol 'tcp'
set firewall name iot-trusted rule 401 action 'accept'
set firewall name iot-trusted rule 401 description 'rule: accept_moonlight_udp'
set firewall name iot-trusted rule 401 source group address-group 'moonlight_clients'
set firewall name iot-trusted rule 401 destination port '47998,47999,48000,48002,48010'
set firewall name iot-trusted rule 401 destination address '10.66.2.22'
set firewall name iot-trusted rule 401 protocol 'udp'
