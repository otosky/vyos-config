...
set service dhcp-server shared-network-name LAN subnet 10.66.0.0/24 static-mapping switch03 ip-address '10.66.0.13'
set service dhcp-server shared-network-name LAN subnet 10.66.0.0/24 static-mapping switch03 mac-address '70:A7:41:C1:A6:B2'
...
set service dhcp-server shared-network-name SERVERS subnet 10.66.1.0/24 static-mapping truenas01 mac-address '50:6B:4B:42:96:1C'
...
set service dhcp-server shared-network-name SERVERS subnet 10.66.1.0/24 static-mapping kube-server04 ip-address '10.66.1.44'
set service dhcp-server shared-network-name SERVERS subnet 10.66.1.0/24 static-mapping kube-server04 mac-address '38:05:25:31:5A:8A'
...
set service dhcp-server shared-network-name IOT subnet 10.66.3.0/24 static-mapping bravia01 ip-address '10.66.3.21'
set service dhcp-server shared-network-name IOT subnet 10.66.3.0/24 static-mapping bravia01 mac-address '28:2E:89:20:8B:B4'
