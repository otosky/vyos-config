...
set interfaces bridge br0 vif 20 description 'TRUSTED'
set interfaces bridge br0 vif 30 address '192.168.50.1/24'
...
set interfaces wireguard wg01 peer ot-framework public-key 'rEU7DZLDS6BNd+pe3GgbbqvLJBDfQLDSFdjzXOczpDg='
